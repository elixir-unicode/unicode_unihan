defmodule Unicode.Unihan.Http do
  @moduledoc false

  # Cloned from cldr_utils

  @unicode_unihan_unsafe_https "UNICODE_UNIHAN_UNSAFE_HTTPS"
  @unicode_unihan_default_timeout "120000"
  @unicode_unihan_default_connection_timeout "60000"
  ...
  * The environment variable `https_proxy`
  ...
  defp http_opts(hostname, options) do
    default_timeout =
      "CLDR_HTTP_TIMEOUT"
      |> System.get_env(@unicode_unihan_default_timeout)
      |> String.to_integer()

    default_connection_timeout =
      "CLDR_HTTP_CONNECTION_TIMEOUT"
      |> System.get_env(@unicode_unihan_default_connection_timeout)
      |> String.to_integer()
  ...
  defp secure_ssl? do
    case System.get_env(@unicode_unihan_unsafe_https) do
      nil -> true
      "FALSE" -> false
      "false" -> false
      "nil" -> false
