defmodule Unicode.Unihan.MixProject do
  ...
  def docs do
    [
      ...
      extras: [
        "README.md",
        "docs/properties/properties.md",
        "docs/properties/dictionary_indices.md",
        "docs/properties/dictionary_like_data.md",
        "docs/properties/irg_sources.md",
        "docs/properties/numeric_values.md",
        "docs/properties/other_mappings.md",
        "docs/properties/radical_stroke_counts.md",
